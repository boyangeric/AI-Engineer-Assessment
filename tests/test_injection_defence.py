...
from policy_qa.agents.prompt_blocks import build_evidence_block, build_grading_block
from policy_qa.schemas import RetrievedDocument
...
def test_grading_block_uses_delimited_evidence():
    ...
    assert block.startswith("User question: What about MFA?")
